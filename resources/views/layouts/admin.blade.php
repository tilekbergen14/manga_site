    ...
    <nav class="bg-gray-800 text-white">
        <div class="container">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="w-full md:w-1/3 flex">
                    <form action="/admin/manga" class="flex w-full">
                        <input
        ...
        <div class="bg-gray-700  py-3">
            <div class="flex justify-between container">
                <ul class="flex">
                    <li class="mr-2"><a href="/admin">Админ</a></li>
                    <li class="mr-2"><a href="/admin/manga">Мангалар</a></li>
                    <li class="mr-2 "><a href="/admin/manga/create">Манга қосу</a></li>
                    <li class="mr-2 bg-white" style="width: 2px"></li>
                    <li class="mr-2"><a href="/admin/episode">Бөлімдер</a></li>
                    <li class="mr-2 "><a href="/admin/episode/create">Бөлімдер Қосу</a></li>
                    <li class="mr-2 bg-white" style="width: 2px"></li>
                    <li class="mr-2"><a href="/admin/user">Пайдаланушылар</a></li>
                </ul>
                <ul>
                    @auth
